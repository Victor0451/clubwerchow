  ...
  return (
    <div id="course">
      <div className="col-12 narrow text-center mb-4">
        <h1 className="mt-4 mb-4">Acerca Del Club</h1>
        <div className="heading-underline"></div>
        <p className="lead mt-4 mb-4 ">
          <strong>Club Werchow</strong> es un programa de beneficios agrupados
        ...
        <p className="lead mt-4 mb-4">
          <strong>¡Suscribite y empezá a ser parte de este club!</strong>
        </p>
